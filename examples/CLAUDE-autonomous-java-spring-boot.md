...
<!--
  EXAMPLE OUTPUT - This file was generated by prompt-merge.py

  It demonstrates what a merged CLAUDE.md looks like when combining:
  - CLAUDE-base.md (foundation)
  - java/CLAUDE-autonomous-api-first-design.md (autonomous mode)
  - java/spring-boot/CLAUDE-java-spring-boot.md (Spring Boot patterns)

  To create your own, run: ./prompt-merge.py
-->
